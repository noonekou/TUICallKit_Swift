...
func TUICallKitLocalizeFromTable(key: String, table: String) -> String? {
    ...
    let stringsFilePath = (bundlePath as NSString).appendingPathComponent (table + ".strings")
        if let dict = NSDictionary(contentsOfFile: stringsFilePath) as? [String: String] {
