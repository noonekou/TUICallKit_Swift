...
public class CallBridge {
    ...
    public func setBeautyLevel(beautyLevel: Float) {
        Logger.info("CallBridge->setBeautyLevel. beautyLevel:\(beautyLevel)")
        DispatchQueue.main.async {
            CallManager.shared.setBeautyLevel(beautyLevel: beautyLevel)
        }
    }
